...
struct BoundingBox
{
    ...
    BoundingBox() = default;
    BoundingBox(std::shared_ptr<Object> _o);
...
public:
    ...
    OrientedBoundingBox(std::shared_ptr<Object> _o, glm::mat3 &_transform) : BoundingBox(_o), transform(_transform) {}
...
public:
    ...
    AxisBoundingBox(std::shared_ptr<Object> _o) : OrientedBoundingBox(_o, DEFAULT_TRANSFORM) {}

...
protected:
    ...
    SortedPairs sort_primitives_by_morton_code(const BoundingBox &global_bbox, const std::vector<glm::vec3> &centers, size_t primitive_count)
    {
        ...
        MortonEncoder<Morton> encoder(global_bbox, size_t(1) << bit_count);

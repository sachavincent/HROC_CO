...
TEST_F(VfcTest, Vfc_Case_1)
{
    ...
    std::shared_ptr<BoundingBox> bb1 = std::shared_ptr<BoundingBox>(new AxisBoundingBox(glm::vec3(0, 0, 5), glm::vec3(2, 2, 2)));

    std::shared_ptr<BoundingBox> bb2 = std::shared_ptr<BoundingBox>(new AxisBoundingBox(glm::vec3(100, 0, 0), glm::vec3(10, 10, 10)));

    std::shared_ptr<BoundingBox> bb3 = std::shared_ptr<BoundingBox>(new AxisBoundingBox(glm::vec3(0, 0, 1000000), glm::vec3(2, 2, 2)));

    std::shared_ptr<BoundingBox> bb4 = std::shared_ptr<BoundingBox>(new AxisBoundingBox(glm::vec3(0, 0, -5), glm::vec3(2, 2, 2)));
    std::shared_ptr<BoundingBox> bb5 = std::shared_ptr<BoundingBox>(new AxisBoundingBox(glm::vec3(10, 10, 10), glm::vec3(2, 2, 2)));
...
TEST_F(VfcTest, Vfc_Case_2)
{
    ...
    std::shared_ptr<BoundingBox> bb3 = std::shared_ptr<BoundingBox>(new AxisBoundingBox(glm::vec3(0, 0, 10000), glm::vec3(2, 2, 2)));
